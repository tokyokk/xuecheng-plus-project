...
public class VideoTask {
    ...
    public void shardingJobHandler() throws Exception {
        ...
        mediaProcessList.forEach(mediaProcess -> {
            ...
            executorService.execute(() -> {
                try {
                    ...
                    // 上传到minio
                    boolean flag = mediaFileService.addMediaFilesToMinion(mp4File.getAbsolutePath(), "video/mp4", bucket, objectName);
                    if (!flag) {
                    ...
                    // 更新任务状态为成功
                    mediaFileProcessService.saveProcessFinishStatus(taskId, "2", fileId, url, "执行任务成功");
                } finally {
                    // 计数器减去1
        ...
        // 阻塞,制定最大限制的等待时间,阻塞最多等待一定时间后解除阻塞
