...
CREATE TABLE `xc_choose_course`  (
  ...
  `valid_days` int(11) NOT NULL COMMENT '课程有效期(天)',
  `status` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '选课状态',
  `validtime_start` datetime(0) NOT NULL COMMENT '开始服务时间',
  `validtime_end` datetime(0) NOT NULL COMMENT '结束服务时间',
...
CREATE TABLE `xc_course_tables`  (
  ...
  `choose_course_id` bigint(20) NOT NULL COMMENT '选课订单id',
  ...
  `create_date` datetime(0) NOT NULL COMMENT '添加时间',
  `validtime_start` datetime(0) NULL DEFAULT NULL COMMENT '开始服务时间',
  `validtime_end` datetime(0) NOT NULL COMMENT '到期时间',
...
CREATE TABLE `xc_learn_record`  (
  ...
  `learn_date` datetime(0) NULL DEFAULT NULL COMMENT '最近学习时间',
  `learn_length` bigint(20) NULL DEFAULT NULL COMMENT '学习时长',
  `teachplan_id` bigint(20) NULL DEFAULT NULL COMMENT '章节id',
