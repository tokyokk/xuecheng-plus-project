...
CREATE TABLE `xc_pay_record`  (
  ...
  `pay_no` bigint(20) NOT NULL COMMENT '本系统支付交易号',
...
) ENGINE = InnoDB AUTO_INCREMENT = 1577419635984793602 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
